...
public class MySQLDatabase implements Database {
    ...
    @Override
    public void insertMessageToDB(List<ConsumerRecord<String, student>> records) throws SQLException {
        Connection connection = db.getConnection();

        String query = "INSERT IGNORE INTO `alumnos`(`partition`, `offset`, `studentid`, `name`, `dept`, `subject`,`marks`) VALUE (?, ?, ?, ?, ?, ?, ?)";
